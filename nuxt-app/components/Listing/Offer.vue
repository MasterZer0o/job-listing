...
async function linkToSeniority(e: MouseEvent) {
  e.preventDefault()
      ...
      <div class="offer-info">
        ...
        <div class="row">
          ...
          <section class="skills">
            <ul>
              <li v-for="skill in offer.skills" :key="skill" @click="withSkill($event, 1)">
                <div>{{ skill }}</div>
              </li>
            </ul>
          </section>
